  ...
  return (
    <Section id="contact">
      ...
      <div className="flex flex-row items-center justify-center gap-4">
        ...
        <Button as={Link} href="https://github.com/pranshuj73" aria-label="GitHub" isIconOnly color="primary" variant="faded" isExternal> <GitHubIcon /> </Button>
        <Button as={Link} href="https://blog.pranshujha.com/" aria-label="My Blog" isIconOnly color="primary" variant="faded" isExternal> <BlogIcon /> </Button>
      </div>
    </Section>
  )
}