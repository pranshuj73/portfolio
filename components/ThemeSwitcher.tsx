...
export default function ThemeSwitcher() {
  ...
  if (theme === 'dark') return (
    <Button className="bg-background" variant="ghost" isIconOnly onPress={() => setTheme('light')} >
      <LightThemeIcon />
    </Button>
  )
  else return (
    <Button className="bg-background" variant="ghost" isIconOnly onPress={() => setTheme('dark')} >
      <DarkThemeIcon />
    </Button>
  )
};