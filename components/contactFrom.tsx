...
export default function ContactForm() {
  return (
    <section className="px-10 py-24 mx-auto flex flex-col items-center text-gray-400">
      <div className="flex flex-col md:w-full">
        ...
        <h1 className="text-left mt-3">email: pranshuj9801@gmail.com</h1>
      </div>
      <div className="flex flex-row flex-wrap items-center justify-center mt-4 -mx-5">
